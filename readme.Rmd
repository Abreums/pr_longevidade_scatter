...
Vamos fazer um diagram de dispersão semelhante ao da figura 2.1 do livro ModernDive, porém, neste caso, estamos cruzando o PIB dos municípios paranenses com a expectativa de vida, os pontos serão dimensionados pela população e coloridos conforme a região (para isto precisamos transformar os dados de região em fatores).
...
Não ficou bom. Vamos mudar a escala de x para logarítmica para melhor visualização dos dados. Vamos também ajustar os nomes dos eixos e das legendas. E, vamos incluir uma linha com a média de expectativa de vida do Brasil.
...
Alternativamente podemos trocar a expectativa de vida pelo Índice de Desenvolvimento Humano de longevidade, e o PIB por PIB per capita.
